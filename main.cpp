...
#include <conio.h> // Allows the use of _getch() for masking password input on Windows.
...
public:
    void signup() { // Handles user signup process.
        ...
        do {
            ...
            password = ""; // Initializes password as an empty string.
            while ((ch = _getch()) != '\r') { // Reads password input without echoing.
                if (ch == 8 && password.length() > 0) { // Handles backspace.
                    password.pop_back(); // Removes last character from password.
                    cout << "\b \b"; // Moves cursor back to overwrite the character.
                } else if (ch != 8 && password.length() < 8) { // Limits input to 8 characters.
                    password += ch; // Adds character to password.
                    cout << "*"; // Displays asterisks for each character.
                }
            }
            cout << endl; // Moves to the next line after password input.
    ...
    void login() { // Handles user login process.
        ...
        char ch; // Variable to store character input.
        enteredPassword = ""; // Initializes entered password as an empty string.
        while ((ch = _getch()) != '\r') { // Reads password input without echoing.
            if (ch == 8 && enteredPassword.length() > 0) { // Handles backspace.
                enteredPassword.pop_back(); // Removes last character from entered password.
                cout << "\b \b"; // Moves cursor back to overwrite the character.
            } else if (ch != 8) { // If the character is not backspace.
                enteredPassword += ch; // Adds character to entered password.
                cout << "*"; // Displays asterisks for each character.
            }
        }
        cout << endl; // Moves to the next line after password input.
    ...
    void adminLogin() { // Handles admin login process.
        ...
        char ch; // Variable to store character input.
        while ((ch = _getch()) != '\r') { // Reads password input without echoing.
            if (ch == 8 && !enteredPassword.empty()) { // Handles backspace.
                enteredPassword.pop_back(); // Removes last character from entered password.
                cout << "\b \b"; // Moves cursor back to overwrite the character.
            } else if (ch != 8) { // If the character is not backspace.
                enteredPassword += ch; // Adds character to entered password.
    ...
    void requestLoan() { // Handles loan request process for the current user.
        ...
        cout << "Enter password: "; // Prompts for password.
        char ch; // Variable to store character input.
        string enteredPassword = ""; // Initializes entered password as an empty string.
        while ((ch = _getch()) != '\r') { // Reads password input without echoing.
            if (ch == 8 && !enteredPassword.empty()) { // Handles backspace.
                enteredPassword.pop_back(); // Removes last character from entered password.
                cout << "\b \b"; // Moves cursor back to overwrite the character.
